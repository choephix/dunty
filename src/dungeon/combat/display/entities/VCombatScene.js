...
const BACKDROP_PRESETS = [
    [`https://undroop-assets.web.app/blackbeard/bg-1920x1920/4.jpg`, 0xc0d0f0, true, BLEND_MODES.SUBTRACT, 0xffffff, 0.2],
    [`https://undroop-assets.web.app/davinci/3/bg/grid2.webp`, 0x404050, true, BLEND_MODES.ADD, 0xf03030, 0.3],
];
export class VCombatScene extends VScene {
    constructor() {
        super();
        const BACKDROP_PRESET_INDEX = 0;
        const [backdropTextureId, backdropTint, backdropStretch, lnBlendMode, lnTint, lnAlpha] = BACKDROP_PRESETS[BACKDROP_PRESET_INDEX];
        {
...
//# sourceMappingURL=VCombatScene.js.map