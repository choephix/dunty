...
export class ConsumablesList extends Container {
    constructor(consumables = UserCrossCombatData.current.consumables) {
        super();
        this.consumables = consumables;
        this.onEnterFrame = createEnchantedFrameLoop(this);
        this.sprites = new Map();
        // consumables.push(...ConsumableItemBlueprints);
        this.onEnterFrame.watch.array(() => this.consumables, () => this.update(), true);
...
//# sourceMappingURL=ConsumablesList.js.map