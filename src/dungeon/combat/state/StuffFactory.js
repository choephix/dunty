...
export function generateDaggerCard() {
    return {
        cost: 0,
        type: "atk",
        value: 1,
...
export function generateBloatCard(key) {
...
export const generateRandomPlayerCard = createRandomizedFactory([
    [
        8,
        () => {
...
function generateStatusEffectCard(statusProperty) {
    ...
    let keys = Object.keys(StatusEffectBlueprints);
...
//# sourceMappingURL=StuffFactory.js.map