...
export async function resolveNewItemRewardPresentation(vscene) {
    ...
    spawnSpriteWave(waveTextureUrl, { pixi: { scale: 2.0 }, duration: 1 }, { x: vitem.x, y: vitem.y, blendMode: BLEND_MODES.ADD, parent: vscene });
...
//# sourceMappingURL=resolveGainItemScreen.js.map