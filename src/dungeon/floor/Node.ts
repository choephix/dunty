...
export class Node extends Container {
  ...
  onEnterFrame() {
    this.rotation = -(this.parent?.rotation ?? 0);
  }
  ...
  addClickHandler(onClick?: () => void) {
    ...
    return () => {
      if (onClick) this.off("pointertap", onClick);
    };
  }
}
...
export class RegularNode extends Node {
  ...
  init() {
    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-2/crown_blue.png"));
    ...
    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-2/ornament_wings.png"));
    ...
    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-4/ribbon_blue.png"));
    ...
    // {
    //   const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-2/ribbon_blue.png"));
    ...
    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-2/frame_gold.png"));
    ...
    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-2/frame_silver.png"));
      sprite.anchor.set(0.5);
    ...
    {
      const sprite = this.addChild(spriteFromUrl(`https://undroop-assets.web.app/confucius/ui/ranks-1/${icon}.png`));
      sprite.anchor.set(0.5);
...
export class BossNode extends Node {
  v1() {
    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-1/wings_blue.png"));
      sprite.anchor.set(0.5, 0.589);
      sprite.scale.set(0.25);
    }

    {
      // const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-4/frame_gold.png"));
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-2/frame_bronze.png"));
      sprite.anchor.set(0.5);
      sprite.scale.set(1 / 3);
    }

    {
      const sprite = this.addChild(spriteFromUrl("https://undroop-assets.web.app/confucius/ui/ranks-1/icon_skull_2.png"));
      sprite.anchor.set(0.5);
    }
  }
